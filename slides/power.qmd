...
Beregn en samlet SE for differencen: $SE_{diff} = \sqrt{SEM_{1}^2 + SEM_2^2}$

Og et 95% konfidensinterval:

$(\mu_1 - \mu_2) \pm 1.96SE _{diff}$
...
Hvor mange patienter skal vi have med i vores forsøg for at vi kan forvente at se en effekt af ene bestemt størrelse? 
::::
:::: {.fragment}
...
::::
:::: {.fragment}
Og vi ved så, at vi kan beregne standardfejlen ved 
...
Ønsket effekt vi vil kunne opdage er 1$\sigma$
...
$\text{SE} = \sqrt{SE_1^2 + SE_2^2} = \sqrt{\frac{\sigma^2}{n_1} + \frac{\sigma^2}{n_2}} = \sqrt{\sigma^2(\frac{1}{n_1} + \frac{1}{n_2})} = \sigma\sqrt{\frac{1}{n_1} +\frac{1}{n_2}}$
...
$\frac{\text{effekt}}{\text{standardfejl}} = z_{1-α/2}+z_{1-β}$
...
Hvis den sande $\mu$ (og det er altså for de rygende kvinder) er under 3200 gram (eller over 3800 gram),
...
::::
:::: {.fragment}
$\beta = 0.1$, $\delta = 300$, $SE = \frac{\sigma}{\sqrt{n}}$, $\sigma = 430$, $\alpha = 0.05$
::::
:::: {.fragment}
Indsæt
::::
