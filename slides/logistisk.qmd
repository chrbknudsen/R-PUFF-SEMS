...
:::: {.smaller}
:::: {.fragment}
Hvad sker der med oddsratio for fosterdød når mors alder stiger?
::::
:::: {.fragment}
Husk at det er i enheder af 10 år
::::
:::: {.fragment}
Find: Oddsratio og 95% KI for I((mage-25)/10)
::::
:::: {.fragment}
Signifikant?
::::
...
Derfor er det odds-_ratio_ vi beregner!

Og derfor er det ikke specielt meningsfuldt at beregne sandsynligheder ved en aldersstigning.

Derfor taler vi _heller ikke_ om at der er 2.1 gange højere sandsynlighed (!)

Det er 2.1 gange højere _odds_ der er associeret med en stigning på 10 år i mors alder.
